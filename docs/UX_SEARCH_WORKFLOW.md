...
> Flangeway: **44 mm**  
> Allowed range: **41–45 mm**  
> Source: IRPWM 2024, clause / page reference  
> Status: verified
...
- **Used in** — drawings / assemblies using this entity
- **Specified by** — standards / specifications
- **Requires** — requirements / acceptance criteria
- **Inspected by** — procedures / inspection criteria
- **Related drawings** — connected drawings
- **Related documents** — manuals / specifications
- **Revisions** — previous and subsequent versions

Each item should be selectable without losing the current context.

## 6. Graph as a supporting surface

The Three.js graph remains useful for exploration, but it should answer a follow-up question such as:

> "Show me how this drawing connects to its requirements and inspection procedure."

Required interactions for the first iteration:
...
```text
Search: T-6155  /  Drawing T-6155  /  Revision R2  /  Requirement
```
